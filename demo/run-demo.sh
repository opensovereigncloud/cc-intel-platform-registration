...
deploy_helm() {
  ...
  # Create namespace
  echo -e "${YELLOW}Creating namespace cc-intel-reg-svc-demo...${NC}"
  kubectl create namespace cc-intel-reg-svc-demo
  ...
  kubectl create secret docker-registry reg-svc-pull-secret \
    ...
    --namespace cc-intel-reg-svc-demo

  # Install Helm chart
  echo -e "${YELLOW}Installing Helm chart...${NC}"
  helm install reg-svc --namespace cc-intel-reg-svc-demo helm-chart/ \
  ...
  kubectl get pod -n cc-intel-reg-svc-demo
